...
The application supports one global service only: wash, dry, or express. Return a service only when the request clearly states one compatible global service. If services conflict across items, return service null and include service in unresolvedFields. Do not choose a service merely because it seems suitable.
